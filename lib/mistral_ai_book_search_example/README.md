...
<video width="540" height="1176" controls>
  <source src="../../docs/assets/mistralai_book_search_example.mp4" type="video/mp4">
  Demo of book search example. Your browser does not support the video tag.
</video>
...
2. Get embeddings for book fragments (precomputed and stored in [assets](../../assets) folder
   1. for each fragment get similarity to question (using cosine similarity)
3. Find 5 most similar fragments to question
4. Ask AI chatbot for answer using the most similar fragment and question
